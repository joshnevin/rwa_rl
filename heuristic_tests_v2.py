...
#     topology_1 = pickle.load(f)
# with open(current_directory+'/topologies/googleb4_5-paths.h5', 'rb') as f:
#     topology_5 = pickle.load(f)
with open(current_directory+'/topologies/euro_backbone_5-paths.h5', 'rb') as f:
    topology_5 = pickle.load(f)
...
node_request_probabilities = pickle.load(open("node_req_probs/28_node_uniform.pkl",'rb'))
# node_request_probabilities = pickle.load(open("node_req_probs/gb4_population.pkl",'rb'))
...
env_args_5 = dict(topology=topology_5, seed=10, load = load,
                ...
                mean_service_holding_time=1e8,
                episode_length=ep_len, node_request_probabilities=node_request_probabilities, exp_request_res = req_br,
                term_on_first_block=tfb, num_spectrum_resources=100)
