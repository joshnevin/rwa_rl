...
# base_topology_name = 'googleb4.txt'
base_topology_name = 'euro_backbone.txt'
...
# new_topology_name = 'googleb4_'+str(k_paths)+'-paths.h5'
new_topology_name = 'euro_backbone_'+str(k_paths)+'-paths.h5'

topology = get_topology('./topologies/'+base_topology_name, 'EUROBACKBONE', k_paths=k_paths)
